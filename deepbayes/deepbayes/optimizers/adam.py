...
class Adam(optimizer.Optimizer):
    ...
    def step(self, features, labels, lrate):
        ...
        sq_grad = np.asarray(sq_grad, dtype=object); self.m = np.asarray(self.m, dtype=object)
        posti_var = np.asarray(posti_var, dtype=object) 
    ...
    def old_step(self, features, labels, lrate):
        ...
        #print("sq: ", sq_grad)            
        sq_grad = np.asarray(sq_grad, dtype=object); self.m = np.asarray(self.m, dtype=object)
        self.posterior_var = np.asarray(self.posterior_var, dtype=object) 
